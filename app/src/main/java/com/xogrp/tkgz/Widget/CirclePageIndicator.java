...
//https://bitbucket.org/xunlei842/viewpager/src/9a881c8c627f/library/src/com/viewpagerindicator/CirclePageIndicator.java
...
implements PagerIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attributeSet, int defaultStyle) {
		...
		TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.CirclePagerIndicator, defaultStyle, R.style.Widget_CirclePageIndicator);
		
		mIsJustified = typedArray.getBoolean(R.styleable.CirclePagerIndicator_isJustified, defaultIsJustified);
		mOrientation = typedArray.getInt(R.styleable.CirclePagerIndicator_orientation, defaultOrientation);
		mPaintStroke = new Paint(Paint.ANTI_ALIAS_FLAG);
		mPaintStroke.setStyle(Style.STROKE);
		mPaintStroke.setColor(typedArray.getColor(R.styleable.CirclePagerIndicator_strokeColor, defaultStrokeColor));
		mPaintStroke.setStrokeWidth(typedArray.getDimension(R.styleable.CirclePagerIndicator_strokeWidth, defaultStrokeWidth));
		mPaintFill = new Paint(Paint.ANTI_ALIAS_FLAG);
		mPaintFill.setStyle(Style.FILL);
		mPaintFill.setColor(typedArray.getColor(R.styleable.CirclePagerIndicator_fillColor, defaultFillColor));
		mRadius = typedArray.getDimension(R.styleable.CirclePagerIndicator_radius, defaultRadius);
		mIsSnapped = typedArray.getBoolean(R.styleable.CirclePagerIndicator_isSnapped, defaultIsSnapped);
